...
- [`clickhouse-server`](#clickhouse-server)
    ...
    - [`ghcr.io/duyet/docker-images:clickhouse_25.26`](#clickhouse-serverclickhouse_2526)
...
### [`clickhouse-server/clickhouse_25.26`](clickhouse-server/clickhouse_25.26/Dockerfile)

Install from the command line

```bash
docker pull ghcr.io/duyet/docker-images:clickhouse_25.26
```

Use as base image in Dockerfile:

```Dockerfile
FROM ghcr.io/duyet/docker-images:clickhouse_25.26
```
